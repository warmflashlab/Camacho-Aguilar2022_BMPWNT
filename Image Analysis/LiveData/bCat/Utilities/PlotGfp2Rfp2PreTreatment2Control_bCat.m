function PlotGfp2Rfp2PreTreatment2Control_bCat(data_direc_OUT,plotError,plotlegend,newplot,blackbackground)

% load([data_direc_OUT filesep 'singleCellsCleanNucMarker.mat'])
...
% singleCells=singleCellsCleanNucMarker;
...
% nconditionsplot = [2,11,14,8,7];
% nconditionsplot = [3,10,15,17,7];
...
if plotlegend
[~, hobj, ~, ~] =legend(analysisParam.conNames,'Location','eastoutside','FontSize',18,'FontName','Myriad Pro','LineWidth',2,'TextColor','w','Color','k','EdgeColor','w');
...
ylabel([analysisParam.yMolecule ':RFP:Pretreatment:Control'],'FontSize',18,'FontName','Myriad Pro','FontWeight','bold','Color','w');
if ~newplot
title('GFP:RFP:PreTreatment:Control','Color','w');
end
xlim([xMin xMax]);
...
saveas(fig,[analysisParam.figDir filesep 'Black-GFP2RFP2Pre2Control-bCat-All-nucmin100'],'fig')
saveas(fig,[analysisParam.figDir filesep 'Black-GFP2RFP2Pre2Control-bCat-All-nucmin100'],'svg')
...
saveas(fig,[analysisParam.figDir filesep 'Black-GFP2RFP2Pre2Control-bCat-All-nucmin100'],'pdf')
...
%,'Interpreter','latex','FontWeight','bold');
ylabel([analysisParam.yMolecule ':RFP:Pretreatment:Control'],'FontSize',18,'FontName','Arial','FontWeight','bold');
if ~newplot
...
saveas(fig,[analysisParam.figDir filesep 'GFP2RFP2Pre2Control-bCat'],'fig')
saveas(fig,[analysisParam.figDir filesep 'GFP2RFP2Pre2Control-bCat'],'svg')
...
saveas(fig,[analysisParam.figDir filesep 'GFP2RFP2Pre2Control-bCat-Sumin'],'pdf')
