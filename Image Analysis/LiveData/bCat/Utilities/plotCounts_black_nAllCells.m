function plotCounts_black_nAllCells(singleCells,blackbackground,nAllCells)
...
for iCon = 1:analysisParam.nCon;
        scatter(analysisParam.plotX(1),nAllCells(iCon),20,'filled','MarkerFaceColor',colors(iCon,:),'MarkerEdgeColor',colors(iCon,:));
    hold on
