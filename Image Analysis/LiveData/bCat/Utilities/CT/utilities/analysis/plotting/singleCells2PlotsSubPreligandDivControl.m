...
plot(analysisParam.plotX(1:size(nuc2nucMeans,2)),y,'Color',colors(iCon,:),'LineWidth',lineWidth);
end
...
title('mean signaling, subtract preligand, divide control');
savefig('figures/Gfp2RfpSubPreligandDivControl.fig');
