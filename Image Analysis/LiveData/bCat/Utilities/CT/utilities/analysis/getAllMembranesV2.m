...
% VERSION 2 of getAllMembranes assumes membranes variable is saved with
% other outfiles.
%   
%%
...
iPos = 1;
file = dir([analysisParam.outDirec filesep '*pos' int2str(analysisParam.positionConditions(iPos+1)) '.mat']);
load([analysisParam.outDirec filesep file.name],'membrane');
