...
function segmentCellsAndorMovie_SOX2(direc,pos,chan,paramfile,outfile)
...
%         imgfiles(nimg).w = chan;
        ...
        %------------------
        nuc2 = medfilt2(presubBackground_provided(nuc,userParam.bgimProv,1));
        fimg2 = medfilt2(presubBackground_provided(fimg,userParam.bgimProv,2));
