...
userParam.cytoMargin = 0;
userParam.cytoSize = 8;
userParam.nucShrinkage = 0; %Changed from 2 to 1
userParam.NCRcutoff = [3 Inf];

userParam.bgimProv = 1;
userParam.bgim = '/Volumes/Elena-2020/201125_LiveSOX2_Exp40/Background_Exp39_20201103_103013 AM_MAXProj.tif';
