...
cd(analysisParam.pathnamesave)
ConditionsSelection = [1 2 3 3 ; ... %Plate
                       5 5 5 13];    %Well     
titleplottosave='Comparison-BMP10-mTeSR16';
...
title = 'Comparison-BMP10-mTeSR16';
[sidx,ordercolors]=sort(channelnums);
uniformlimits = 1;
