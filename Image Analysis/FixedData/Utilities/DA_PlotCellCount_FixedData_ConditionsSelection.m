...
angleticks = 0;
uniformlimits = 1;
microscope = 1; %1=Spinning Disk (20x), 2=LSM2 (20x)
...
if microscope ==1 %SD 20x
    rationumbercells = 100/((0.617289*1024/1000)^2);
elseif microscope==2 %LSM2 20x
    rationumbercells = 100/((636.40/1000)^2);
end
    ...
    for condnum = 1:nCon
        ...
        if stdmean
            ...
            for posnum = 1:AllDataExperiment{ConditionsSelection(1,condnum)}{ConditionsSelection(2,condnum)}(end,end)
                ...
                meanDataAux(posnum) = length(AllDataExperiment{ConditionsSelection(1,condnum)}{ConditionsSelection(2,condnum)}(indposnum,1))*rationumbercells;%(10000^2)/(665.6^2);%34.77/5;
            end
