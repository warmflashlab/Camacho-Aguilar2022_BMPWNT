function HeatScatter3D_FixedData_singleCells(samplenumber,blackBG) 
...
singleCells = singleCells{samplenumber};
...
for conditionnum=2:analysisParam.nCon
        ...
        DataPlot = [DataPlot;singleCells{analysisParam.ConditionOrder(conditionnum)}(:,3+analysisParam.ChannelOrder3D)];
...
if blackBG
    ...
    for conditionnum = 1:analysisParam.nCon
        ...
        DataPlot = singleCells{analysisParam.ConditionOrder(conditionnum)}(:,3+analysisParam.ChannelOrder3D);
