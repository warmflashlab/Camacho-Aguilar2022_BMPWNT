function ScatterCellClassificationFixedSingleTimePointv2_CMYK(samplenumber,blackbackground) 
...
%         subplot(1,4,conditionnum)
        ...
        if ndimensions == 3
            ...
            xticks(round(linspace(minlim(1),maxlim(1),4),2))
            yticks(round(linspace(minlim(2),maxlim(2),4),2))
            zticks(round(linspace(minlim(3),maxlim(3),4),2))
