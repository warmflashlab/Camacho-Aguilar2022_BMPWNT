...
for ChannelNumber = 1:length(analysisParam.MapChannels.DifferentChannelsPresent)
    ...
    image16bit = imread([analysisParam.pathnamedata,'/',PlateNameUsed,num2str(PNumber(1)),'_W',num2str(WNumber(1)),'_1_MaxProj.tif'],CNumber(1));
    ...
    for imageswithchannel = 1:length(PNumber)
        ...
        for positionnumber = 1:analysisParam.ImagesperWell
            ...
            image16bit = imread([analysisParam.pathnamedata,'/',PlateNameUsed,num2str(PNumber(imageswithchannel)),'_W',num2str(WNumber(imageswithchannel)),'_',num2str(positionnumber),'_MaxProj.tif'],CNumber(imageswithchannel));
            ...
            limitsaux2 = stretchlim(imaux,[0.01 0.99]);
...
mkdir(['Well',num2str(wellnumber)]) 
        ...
        for positionnumber = 1:analysisParam.ImagesperWell
            ...
            for channelnumber = 1:analysisParam.ChannelMaxNum{platenumber}(wellnumber)
              ...
              image16bit = imread([analysisParam.pathnamedata,'/',PlateNameUsed,num2str(platenumber),'_W',num2str(wellnumber),'_',num2str(positionnumber),'_MaxProj.tif'],channelnumber);
...
%     img2showMerge = cat(3,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{3})+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{4})/2,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{2})/2+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{4})/2,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{2})/2);
    ...
    imwrite(imresize(img2showDAPI,imresizelevel),[analysisParam.savingpathforImages,'/Plate',num2str(platenumber),'/Well',num2str(wellnumber),'/Plate',num2str(platenumber),'_Well',num2str(wellnumber),'_',num2str(positionnumber),'_DAPI','_channel.png'])
    ...
    imwrite(imresize(img2showChannel1,imresizelevel),[analysisParam.savingpathforImages,'/Plate',num2str(platenumber),'/Well',num2str(wellnumber),'/Plate',num2str(platenumber),'_Well',num2str(wellnumber),'_',num2str(positionnumber),'_',analysisParam.MapChannels.DifferentChannelsPresent{analysisParam.MapChannels.ChannelsCoordMatrix{platenumber,wellnumber}(2)},'channel.png'])
...
%     imwrite(img2showDAPIChannel1,[savingpathforImages,'/Plate',num2str(platenumber),'/Well',num2str(wellnumber),'/Plate',num2str(platenumber),'_Well',num2str(wellnumber),'_',num2str(positionnumber),'_',analysisParam.MapChannels.DifferentChannelsPresent{analysisParam.MapChannels.ChannelsCoordMatrix{platenumber,wellnumber}(2)},'channel_MergeDAPI.png'])
    ...
    imwrite(imresize(img2showChannel2,imresizelevel),[analysisParam.savingpathforImages,'/Plate',num2str(platenumber),'/Well',num2str(wellnumber),'/Plate',num2str(platenumber),'_Well',num2str(wellnumber),'_',num2str(positionnumber),'_',analysisParam.MapChannels.DifferentChannelsPresent{analysisParam.MapChannels.ChannelsCoordMatrix{platenumber,wellnumber}(3)},'channel.png'])
    ...
    imwrite(imresize(img2showChannel3,imresizelevel),[analysisParam.savingpathforImages,'/Plate',num2str(platenumber),'/Well',num2str(wellnumber),'/Plate',num2str(platenumber),'_Well',num2str(wellnumber),'_',num2str(positionnumber),'_',analysisParam.MapChannels.DifferentChannelsPresent{analysisParam.MapChannels.ChannelsCoordMatrix{platenumber,wellnumber}(4)},'channel.png'])
...
%         img2showMerge =cat(3,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{4})/1.5+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{3})/1.5,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{4})/1.5+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{2})/1.5,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{2})/1.5+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{3})/1.5);
%         img2showMerge =cat(3,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{4})/2+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{3})/2,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{4})/2+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{2})/2,AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{2})/2+AdjustedImage(:,:,OrderChannels{platenumber}{wellnumber}{3})/2);
    ...
    imwrite(imresize(img2showMerge,imresizelevel),[analysisParam.savingpathforImages,'/Plate',num2str(platenumber),'/Well',num2str(wellnumber),'/Plate',num2str(platenumber),'_Well',num2str(wellnumber),'_',num2str(positionnumber),'_Merge.png'])
