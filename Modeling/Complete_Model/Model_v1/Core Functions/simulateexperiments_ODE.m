function EndtrajsExperiments = simulateexperiments_ODE(paramstruct,ExpDataStruct,initcondaux,Istar,nExps,dt,odeopt)
%% SDE fitting
...
%         initcond = [BMPlevel,0,Istar,0,0,0.7308,0.1694,0.0407];
...
% ii
        ...
        solendtraj = simulate_solution_det_eqtn_step_GRNModel(initcond,tspan,BMPlevel,mTeSRBMPlevel,basalBMPlevel,Signals,parametervalue,ExpDataStruct(ii).TimeFixedaux*1.5,odeopt);
