...
mTesrBMPlevel = AllAcceptedParameters(nacceptedpar).mTesrBMPlevel;
basalBMPlevel = AllAcceptedParameters(nacceptedpar).basalBMPlevel;
paramBMPfunc = AllAcceptedParameters(nacceptedpar).paramBMPfunc;
parameter = AllAcceptedParameters(nacceptedpar).parammodel;
...
save('StabilityAnalysis_Real_NON-INTEGERCOEFFITIENTS_v1_Parameters_Method4_findcriticalpointsv4_tF1000')
