...
[root,fval,exitflag,output] = fsolve(@(x) ode_ONLYGRNModel_v8(1,x,parameters), guess,options)
x0=root;
n=0;
...
%         size(parameters)
        ...
        solendtraj = ode15s(@(t,s) ode_ONLYGRNModel_v8(t,s,parameters),[0:0.001:1000],guess,options);
...
%         size(parameters)
        ...
        elseif sum(abs(ode_ONLYGRNModel_v8(0,root,parameters)))>0.00001
            flag=0;
            stability = 2;
