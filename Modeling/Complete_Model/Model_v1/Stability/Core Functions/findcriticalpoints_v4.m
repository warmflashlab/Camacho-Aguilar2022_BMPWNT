function [criticalpoints,Ntrialscritpoints,stability] = findcriticalpoints_v4(npointsdist,X,Y,Z,parameter,BMP,WNT,method)
...
%                         pause()
if stabilityaux == 1
                        if (stability<2)&&(sum(isnan(root))==0)&&(sum(imag(root)>0)==0)
