...
plot(ttrajplot,squeeze(soltraj(8,tpointsplot)),'LineWidth',3,'Color',colorsplotscatter(conditiontosimulateidx,:))
...
saveas(fig,['figures/','PaperFig2_CDX2_',nameMCMCresult,'_AllData_',num2str(jj)],'svg')
saveas(fig,['figures/','PaperFig2_CDX2_',nameMCMCresult,'_AllData_',num2str(jj)],'fig')
saveas(fig,['figures/','PaperFig2_CDX2_',nameMCMCresult,'_AllData_',num2str(jj)],'png')
