...
saveas(fig,['figures/','PaperFig2_BRA_',nameMCMCresult,'_AllData_',num2str(jj)],'svg')
saveas(fig,['figures/','PaperFig2_BRA_',nameMCMCresult,'_AllData_',num2str(jj)],'fig')
saveas(fig,['figures/','PaperFig2_BRA_',nameMCMCresult,'_AllData_',num2str(jj)],'png')
