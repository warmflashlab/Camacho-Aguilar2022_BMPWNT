...
if jj==1
    maxBRA = max(soltraj(7,:));
minBRA = min(soltraj(7,:));
else

maxBRA = max(maxBRA,max(soltraj(7,:)));
minBRA = min(minBRA,min(soltraj(7,:)));
end
...
scatter(soltraj(2,:),soltraj(5,:),40,soltraj(7,:),'filled')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-BRAColorcoded_',condname],'fig')
saveas(fig,['figures/FateMap_NON-IntegerCoeff-BRAColorcoded_',condname],'svg')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-BRAColorcoded_',condname],'pdf')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-BRAColorcoded_ALL'],'fig')
saveas(fig,['figures/FateMap_NON-IntegerCoeff-BRAColorcoded_ALL'],'svg')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-BRAColorcoded_ALL'],'pdf')
