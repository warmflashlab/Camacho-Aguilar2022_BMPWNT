...
if jj==1
    maxSOX2 = max(soltraj(6,:));
minSOX2 = min(soltraj(6,:));
else

maxSOX2 = max(maxSOX2,max(soltraj(6,:)));
minSOX2 = min(minSOX2,min(soltraj(6,:)));
end
...
scatter(soltraj(2,:),soltraj(5,:),40,soltraj(6,:),'filled')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-SOX2Colorcoded_',condname],'fig')
saveas(fig,['figures/FateMap_NON-IntegerCoeff-SOX2Colorcoded_',condname],'svg')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-SOX2Colorcoded_',condname],'pdf')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-SOX2Colorcoded_ALL'],'fig')
saveas(fig,['figures/FateMap_NON-IntegerCoeff-SOX2Colorcoded_ALL'],'svg')
...
saveas(fig,['figures/FateMap_NON-IntegerCoeff-SOX2Colorcoded_ALL'],'pdf')
