function sol=solution_det_eqtn_GRNModel_v9(s0,tspan,p,opt)
...
if opt==1
    ...
    sol=ode15s(@(t,s) ode_GRNModel_v9(t,s,p),tspan,s0,options);
else
options = odeset('InitialStep',0.001);
sol=ode23(@(t,s) ode_GRNModel_v9(t,s,p),tspan,s0,options);
end
