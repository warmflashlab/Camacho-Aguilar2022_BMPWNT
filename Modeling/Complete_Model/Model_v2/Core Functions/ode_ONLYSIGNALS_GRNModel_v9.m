function dydt=ode_ONLYSIGNALS_GRNModel_v9(t,y,p)
...
dydt = [
    ...
    % (4) WNT RNA
    (1-p(18))*(p(7)*(y(2)^p(8) ) ./ ( p(9).^p(8)+(y(2).^p(8)) )  +  ( p(10) * (y(5).^p(11)) ) ./ ( p(12)^p(11)+ (y(5).^p(11)) ))   -  p(13)*y(4); ...  
    
    % (5) Nuclear bCat
    (p(14)*((y(4)+ p(19)*p(20)).^p(15)))./(p(16).^p(15)+(y(4)+ p(19)*p(20)).^p(15))-p(17)*y(5)];
