...
nexttile
plot(yplot(2,:),yplot(4,:),'Color',colorplot,'LineWidth',4)
hold on
...
nexttile
plot(yplot(2,:),yplot(5,:),'Color',colorplot,'LineWidth',4)
hold on
...
nexttile
plot3(yplot(2,:),yplot(4,:),yplot(5,:),'Color',colorplot,'LineWidth',4)
hold on
...
xlim([-0.5,1.5])
grid on
% title('Trajectory on WNT bifurcation plot')
...
plot(BifSet2(:,1),BifSet2(:,2),'--','Color',colorlineuns,'LineWidth',2)
xlim([-0.5,1.5])
% title('Trajectory on bCat bifurcation plot')
grid on
...
plot3(BifSet2(:,1),BifSet4(:,2),BifSet2(:,2),'--','Color',colorlineuns,'LineWidth',2)
xlim([-0.5,1.5])
% title('Trajectory on 3D bifurcation plot')
grid on
...
fig = gcf;
    fig.Color = 'w';
    fig.InvertHardcopy = 'off';
saveas(fig,['figures/','PaperConditionsTrajectoriesBifSet3D'],'svg')
saveas(fig,['figures/','PaperConditionsTrajectoriesBifSet3D'],'fig')
saveas(fig,['figures/','PaperConditionsTrajectoriesBifSet3D'],'png')
