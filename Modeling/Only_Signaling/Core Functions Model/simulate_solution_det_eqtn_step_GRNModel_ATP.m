function [AllXsol,Alltvsol]=simulate_solution_det_eqtn_step_GRNModel_ATP(initcond,tspan,BMPlevels,mTeSRBMPlevel,basalBMPlevel,Signals,p,tsol,odeopt)
...
while flag 
    ...
    if ii==1
        ...
        y0 = solaux.y(:,end);
        y0(1) = basalBMPlevel+BMPlevels*mTeSRBMPlevel^(Signals(1,ii)>0); %Media change changes the ligand value to a proportion of the original BMP levels
